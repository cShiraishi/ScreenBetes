...
st.markdown("---")
st.markdown("""
<div style="text-align: center; margin-top: 20px; opacity: 1.0;">
    <p style="font-size: 1.0rem; color: #888; margin-bottom: 10px; font-weight: bold;">Visitor Stats</p>
    <a href="https://info.flagcounter.com/vcM0">
        <img src="https://s11.flagcounter.com/count2/vcM0/bg_ffffff/txt_000000/border_CCCCCC/columns_3/maxflags_12/viewers_0/labels_0/pageviews_0/flags_0/percent_0/" 
             alt="Flag Counter" border="0" style="height: auto; width: 60%;">
    </a>
</div>
""", unsafe_allow_html=True)
